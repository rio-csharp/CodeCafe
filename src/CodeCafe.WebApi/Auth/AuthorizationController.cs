    ...
    : ControllerBase
{
    ...
    public async Task<IActionResult> Authorize(CancellationToken cancellationToken)
    {
        ...
        {
            return BadRequest(new ApiError("invalid_client", "The OAuth client id is required."));
        }

        var application = await applicationManager.FindByClientIdAsync(request.ClientId, cancellationToken);
        if (application is null)
        {
            return BadRequest(new ApiError("invalid_client", "The OAuth client application is not registered."));
        }
    ...
    public async Task<IActionResult> Exchange(CancellationToken cancellationToken)
    {
        ...
        return BadRequest(new ApiError("unsupported_grant_type", "The requested OAuth grant type is not supported."));
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            Claims.Name or Claims.Email => [Destinations.AccessToken],

...
Before pushing or reporting that CI should be green, run the relevant local checks. For frontend changes, always run `npm run lint` from `frontend` locally and report the result.

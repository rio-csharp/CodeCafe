...
{
    public Task<IReadOnlyList<NotebookSummaryModel>> Handle(GetPublicNotebooksQuery request, CancellationToken cancellationToken)
        => notebookReadService.GetPublicNotebooksAsync(
            request.Search,

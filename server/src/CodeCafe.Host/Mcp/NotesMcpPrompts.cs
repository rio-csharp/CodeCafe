...
public sealed class NotesMcpPrompts
{
    ...
    [Description(
        "Guide a client to summarize a notebook page after fetching its TipTap JSON and plain text with notes_get_page."
    )]
    ...
    [Description(
        "Guide a client to inspect a notebook and propose a folder/page reorganization plan."
    )]

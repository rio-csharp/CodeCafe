...
const workspaces = [
  ...
  {
    id: 'tinycivilization',
    name: 'TinyCivilization',
    initials: 'TC',
    desc: 'Simulation engine for Tiny Civilization. Building AI agents and world models.',
    updatedAt: '1d ago',
    branch: 'main',
    status: 'Healthy' as const,
    showcase: false,
  },
  {
    ...
    name: 'Interview Prep',
    initials: 'IP',
    desc: 'My interview preparation workspace. Notes, code snippets, and system designs.',
    updatedAt: '3d ago',
    branch: 'main',
    status: 'Healthy' as const,
    showcase: false,

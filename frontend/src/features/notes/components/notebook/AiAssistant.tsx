    ...
    return (
      <div className="border-t border-gray-100 px-4 py-3">
        <button
          ...
          className="flex items-center gap-2 w-full text-left hover:bg-gray-50 rounded-md px-2 py-1.5 transition-colors"
        >
    ...
    <div className="border-t border-gray-100 flex flex-col shrink-0">
      <div className="flex items-center justify-between px-4 py-2.5">
        ...
        <button
          ...
          className="p-1 text-gray-400 hover:text-black hover:bg-gray-50 rounded transition-colors"
        >
